...
//       } as DiningBehavior, // Assert that diningBehavior is of the correct type
//     }));
//   };
...
//     <div className="space-y-4">
//       <h3 className="font-medium">{currentPersona.attributes?.[category].label}</h3>
//       <div className="flex flex-wrap gap-2">
//         {currentPersona.attributes?.[category].options.map((option) => (
//           <Button
//             key={option}
//             variant={currentPersona.attributes?.[category].selected.includes(option) ? "default" : "outline"}
